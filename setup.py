...
sys.path.insert(0, "CGATSingleCell")
import version
...
cgat_package_dirs = {'CGATSingleCell': 'CGATSingleCell'}
...
setup(
    ...
    name='CGATSingleCell',
    version=version,
    description='CGATSingleCell : the Computational Genomics Analysis Toolkit',
    author='CGAT developers',
    author_email='andreas.heger@gmail.com',
    license="MIT",
    platforms=["any"],
    keywords="computational genomics",
    long_description='CGATSingleCell : the Computational Genomics Analysis Toolkit',
    ...
    entry_points={
        'console_scripts': ['cgat-singlecell = CGATSingleCell.cgat_singlecell:main']
    },
    # dependencies
